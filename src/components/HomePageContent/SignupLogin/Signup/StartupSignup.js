...
const StartupSignup = ({ handleAction, setDialogOpen }) => {
  const userTypes = [
    {
      id: "4",
      name: "Startup",
    ...
    <>
      <form onSubmit={handleSubmit(onSubmit)}>
        <Box>
          ...
          <Box className={styles.inputExternal}>
            <FormLabel style={{ display: "flex", fontWeight: "400", marginTop: "10px" }}>
          ...
          <Box className={`${styles.dialogExternal} ${styles.signUpText}`}>
            ...
            >
              ...
              By signing up, I agree to Arisio's{" "}
              <span style={{ color: "#8A1538", cursor: "pointer" }}>Term of services</span> and{" "}
              <span style={{ color: "#8A1538", cursor: "pointer" }}>Privacy Policy.</span>
            </Typography>
          </Box>
        </Box>
        ...
        <Box className={styles.inputExternal}>
          <Button
            ...
            type="submit"
          >
            <FormattedMessage id="startUpSignUp.signup.title" defaultMessage="SIGNUP" />
          </Button>
        </Box>
        {msg ? (
          <Box>
